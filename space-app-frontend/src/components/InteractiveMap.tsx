...
function LocationMarker({ latitude, longitude, onLocationChange }: InteractiveMapProps) {
  ...
  const position = latitude && longitude ? [latitude, longitude] as L.LatLngExpression : null
